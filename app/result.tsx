    ...
    <ScreenContainer className="px-5 pt-3" containerClassName="bg-background" edges={["top", "left", "right", "bottom"]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={[styles.prototypeNote, { backgroundColor: `${colors.warning}12`, borderColor: `${colors.warning}35` }]}>
          <Text style={[styles.prototypeNoteText, { color: colors.muted }]}>{outputUrl ? project.motionUri ? "This video was generated by Sync Labs after transferring full-body movement from your reference video, then adding your selected audio. Choose a social app below to share it." : "This video was generated by Sync Labs from your photo and audio reference. Choose a social app below to share it." : hasVideo ? "Choose a social app below to pass the local video into its composer." : params.audioUri ? "Image preview keeps the source photo visible while the selected audio and sync timing are active. Start a new render to generate the animated video." : "Add an audio reference to activate image-to-lip-sync preview."}</Text>
        </View>
